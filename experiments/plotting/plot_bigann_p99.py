...
hnsw_recall, hnsw_latency = load_dataset("bigann-100m_hnsw", "metrics_100m.json", "latency_p99")
flatnav_recall, flatnav_latency = load_dataset("bigann-100m_flatnav", "metrics_100m.json", "latency_p99")
...
plt.subplot(222)
hnsw_recall, hnsw_latency = load_dataset("yandex-deep-100m_hnsw", "metrics_100m.json", "latency_p99")
flatnav_recall, flatnav_latency = load_dataset("yandex-deep-100m_flatnav", "metrics_100m.json", "latency_p99")
...
plt.subplot(223)
hnsw_recall, hnsw_latency = load_dataset("spacev-100m_hnsw", "metrics_100m.json", "latency_p99")
flatnav_recall, flatnav_latency = load_dataset("spacev-100m_flatnav", "metrics_100m.json", "latency_p99")
...
plt.subplot(224)
hnsw_recall, hnsw_latency = load_dataset("tti-100m_hnsw", "metrics_100m.json", "latency_p99")
flatnav_recall, flatnav_latency = load_dataset("tti-100m_flatnav", "metrics_100m.json", "latency_p99")
...
fig.supylabel('P99 Latency (ms)', fontsize = 22)
fig.supxlabel('Recall (R100@100)', fontsize = 22)

plt.tight_layout()
plt.savefig("100m_all_p99.png", dpi=400)
plt.show()
