...
# # Query MNIST
# build/query_npy 0 mnist_784.index data/mnist/mnist-784-euclidean.test.npy data/mnist/mnist-784-euclidean.gtruth.npy 256,512 100 0
...
# build/construct_npy 0 1 data/glove/glove-25-angular.train.npy 16 128 glove_25.index

# # Query GloVe without reordering 
# build/query_npy 1 glove_25.index data/glove/glove-25-angular.test.npy data/glove/glove-25-angular.gtruth.npy 256,512 100 0
