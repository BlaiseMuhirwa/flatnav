...
#include "distances/InnerProductDistance.h"
...
#if defined(USE_AVX512)
static float InnerProductSIMD16ExtAVX512(
        const void *x, const void *y, size_t& dimension) {
}

static float InnerProductSIMD16ResAVX512(
        const void* x, const void* y, size_t& dimension){
}
#endif

#if defined(USE_AVX)
static float InnerProductSIMD16ExtAVX(
        const void* x, const void* y, size_t& dimension) {
}

static float InnerProductSIMD16ResAVX(
        const void* x, const void* y, size_t& dimension){
}
#endif

#if defined(USE_SSE)
static float InnerProductSIMD16ExtSSE(
        const void* x, const void* y, size_t& dimension) {
}

static float InnerProductSIMD16ResSSE(
        const void* x, const void* y, size_t& dimension){
}

static float InnerProductSIMD4ExtSSE(
        const void *x, const void *y, size_t& dimension) {
}

static float InnerProductSIMD4ResSSE(
        const void *x, const void *y, size_t& dimension) {
}
#endif
