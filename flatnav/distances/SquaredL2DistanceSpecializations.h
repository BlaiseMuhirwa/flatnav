...
#if defined(USE_AVX512)
static float L2SqrSIMD16ExtAVX512(
    ...
    float res = tmp_result[0] + tmp_result[1] + tmp_result[2] + tmp_result[3] + 
                ...
                tmp_result[8] + tmp_result[9] + tmp_result[10] + 
                tmp_result[11] + tmp_result[12] + tmp_result[13] + 
                tmp_result[14] + tmp_result[15];
    return res;
}

static float L2SqrSIMD16ResAVX512(
        const void* x, const void* y, size_t& dimension){
...
static float L2SqrSIMD16ExtAVX(
        const void* x, const void* y, size_t& dimension) {
...
static float L2SqrSIMD16ResAVX(
        const void* x, const void* y, size_t& dimension){
...
#if defined(USE_SSE)
static float L2SqrSIMD16ExtSSE(
        const void* x, const void* y, size_t& dimension) {
...
static float L2SqrSIMD16ResSSE(
        const void* x, const void* y, size_t& dimension){
